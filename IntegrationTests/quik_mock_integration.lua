...
_G.N_SetLimitOrder = function(accountCode, clientCode, classCode, securityCode, operation, price, quantity)
  ...
  if not ok then
    Res = "������ sendTransaction: " .. tostring(Res)
  end
  if Res ~= "" then
...
-- ==========================================
-- N_CloseAllOrder (�� Assistant.lua)
-- ==========================================

_G.N_CloseAllOrder = function()
  log.debug("N_CloseAllOrder() ������ ���� �������� ������")
end
...
print("[MOCK] �������������� ��� QUIK API ��������")
print("[MOCK] �����: ����=1000, ���=800, ����=1200, ���=0.1")
print(
  "[MOCK] ��������� (����� > 7 ��������): ����=100%, ���=80%, ����=120%, ���=0.01"
)
