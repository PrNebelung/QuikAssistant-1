...
test("broker exists -> Config filled", function()
  local f = io.open(testFileName, "w")
  f:write('{"VTB": {"clientCode": "386507", "volumeOrderMax": 20000, "brokerEnabled": true, "sessionMainEnabled": true, "sessionMainHour": 10}}')
  f:close()
...
if #errors > 0 then print("\nFailures:"); for _, e in ipairs(errors) do print("  " .. e) end end
