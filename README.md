...
| `BrokerAdapter.lua` | Адаптер QUIK API. Инкапсулирует все вызовы функций QUIK с кешированием. |
...
**НЕ ИСПОЛЬЗОВАТЬ** Edit tool напрямую на `.lua` файлах с русским текстом!
