...
| `QuikFunction.lua` | Фасад для обратной совместимости. Объединяет require-ы всех сервисных модулей: MarketData, PositionService, OrderValidator, TransactionHandler. |
