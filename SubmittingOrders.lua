...
function SubmittingOrdersRun()
  ...
  local ok, err = pcall(function()
    ...
    if isSubmittingOrdersRun then
      log.debug(
        string.format("2.1 �������� ������ �� ������� �� ����� %s", Config.FileBuyOrder)
      )
    ...
    log.debug(
      string.format("2.7 �������� ������ �� ������� �� ����� %s", Config.FileSellOrder)
    )
          ...
          if isFileSellEdge ~= nil then
            ...
            if tonumber(priceMax) == nil or tonumber(priceMax) == 0 then
              ...
              if positionQty > 0 then
                ...
                log.error(
                  string.format("[SKIP] ������� �� ������� ��� ����� ���� [%s]", order.SecurityCode)
                )
              end
            end
  ...
  for i, order in pairs(orders) do
    ...
    elseif IsSendOrder(order) then
      ...
      if not isCheck then
        ...
        if error ~= "" then
          stats.rejected = stats.rejected + 1
          log.error("�� ������� ��������� ������ � QUIK: ", error, order:Print())
        else
